...
class Endurance2 extends StatefulWidget {
  const Endurance2({Key? key}) : super(key: key);

  @override
  _Endurance2State createState() => _Endurance2State();
}

class _Endurance2State extends State<Endurance2> {
  List<Map<String, dynamic>> endurance2Exercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    const collectionName = 'endurance_2';
    ...
    try {
      ...
      setState(() {
        endurance2Exercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: endurance2Exercises.isEmpty
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in endurance2Exercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: endurance2Exercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
