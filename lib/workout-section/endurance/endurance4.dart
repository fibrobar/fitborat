...
class Endurance4 extends StatefulWidget {
  const Endurance4({Key? key}) : super(key: key);

  @override
  _Endurance4State createState() => _Endurance4State();
}

class _Endurance4State extends State<Endurance4> {
  List<Map<String, dynamic>> endurance4Exercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    const collectionName = 'endurance_4';
    ...
    try {
      ...
      setState(() {
        endurance4Exercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: endurance4Exercises.isEmpty
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in endurance4Exercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: endurance4Exercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
