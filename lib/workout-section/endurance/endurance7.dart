...
class Endurance7 extends StatefulWidget {
  const Endurance7({Key? key}) : super(key: key);

  @override
  _Endurance7State createState() => _Endurance7State();
}

class _Endurance7State extends State<Endurance7> {
  List<Map<String, dynamic>> endurance7Exercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    const collectionName = 'endurance_7';
    ...
    try {
      ...
      setState(() {
        endurance7Exercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: endurance7Exercises.isEmpty
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in endurance7Exercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: endurance7Exercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
