...
class Endurance6 extends StatefulWidget {
  const Endurance6({Key? key}) : super(key: key);

  @override
  _Endurance6State createState() => _Endurance6State();
}

class _Endurance6State extends State<Endurance6> {
  List<Map<String, dynamic>> endurance6Exercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    const collectionName = 'endurance_6';
    ...
    try {
      ...
      setState(() {
        endurance6Exercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: endurance6Exercises.isEmpty
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in endurance6Exercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: endurance6Exercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
