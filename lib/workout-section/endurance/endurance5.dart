...
class Endurance5 extends StatefulWidget {
  const Endurance5({Key? key}) : super(key: key);

  @override
  _Endurance5State createState() => _Endurance5State();
}

class _Endurance5State extends State<Endurance5> {
  List<Map<String, dynamic>> endurance5Exercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    const collectionName = 'endurance_5';
    ...
    try {
      ...
      setState(() {
        endurance5Exercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: endurance5Exercises.isEmpty
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in endurance5Exercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: endurance5Exercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
