...
class Fatloss6 extends StatefulWidget {
  const Fatloss6({Key? key}) : super(key: key);

  @override
  _Fatloss6State createState() => _Fatloss6State();
}

class _Fatloss6State extends State<Fatloss6> {
  List<Map<String, dynamic>> fatloss6Exercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    const collectionName = 'fat_loss_6';
    ...
    try {
      ...
      setState(() {
        fatloss6Exercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: fatloss6Exercises.isEmpty
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in fatloss6Exercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: fatloss6Exercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
