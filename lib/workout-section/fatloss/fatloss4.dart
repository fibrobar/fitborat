...
class Fatloss4 extends StatefulWidget {
  const Fatloss4({Key? key}) : super(key: key);

  @override
  _Fatloss4State createState() => _Fatloss4State();
}

class _Fatloss4State extends State<Fatloss4> {
  List<Map<String, dynamic>> fatloss4Exercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    const collectionName = 'fat_loss_4';
    ...
    try {
      ...
      setState(() {
        fatloss4Exercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: fatloss4Exercises.isEmpty
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in fatloss4Exercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: fatloss4Exercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
