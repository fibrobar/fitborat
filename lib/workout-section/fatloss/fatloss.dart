...
class Fatloss extends StatefulWidget {
  const Fatloss({Key? key}) : super(key: key);

  @override
  _FatlossState createState() => _FatlossState();
}

class _FatlossState extends State<Fatloss> {
  List<Map<String, dynamic>> fatlossExercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    try {
      ...
      setState(() {
        fatlossExercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in fatlossExercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: fatlossExercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
