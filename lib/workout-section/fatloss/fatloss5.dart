...
class Fatloss5 extends StatefulWidget {
  const Fatloss5({Key? key}) : super(key: key);

  @override
  _Fatloss5State createState() => _Fatloss5State();
}

class _Fatloss5State extends State<Fatloss5> {
  List<Map<String, dynamic>> fatloss5Exercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    const collectionName = 'fat_loss_5';
    ...
    try {
      ...
      setState(() {
        fatloss5Exercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: fatloss5Exercises.isEmpty
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in fatloss5Exercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: fatloss5Exercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
