...
class _Fatloss1State extends State<Fatloss1> {
  List<Map<String, dynamic>> fatloss1Exercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    const collectionName = 'fat_loss_1';
    ...
    try {
      ...
      setState(() {
        fatloss1Exercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: fatloss1Exercises.isEmpty
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in fatloss1Exercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: fatloss1Exercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
