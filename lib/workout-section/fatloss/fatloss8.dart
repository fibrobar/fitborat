...
class Fatloss8 extends StatefulWidget {
  const Fatloss8({Key? key}) : super(key: key);

  @override
  _Fatloss8State createState() => _Fatloss8State();
}

class _Fatloss8State extends State<Fatloss8> {
  List<Map<String, dynamic>> fatloss8Exercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    const collectionName = 'fat_loss_8';
    ...
    try {
      ...
      setState(() {
        fatloss8Exercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: fatloss8Exercises.isEmpty
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in fatloss8Exercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: fatloss8Exercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
