...
class _MuscleBuilding7State extends State<MuscleBuilding7> {
  List<Map<String, dynamic>> muscleBuilding7Exercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    const collectionName = 'muscle_building_7';
    ...
    try {
      ...
      setState(() {
        muscleBuilding7Exercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: muscleBuilding7Exercises.isEmpty
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in muscleBuilding7Exercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: muscleBuilding7Exercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
