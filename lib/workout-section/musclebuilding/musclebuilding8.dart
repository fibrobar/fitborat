...
class MuscleBuilding8 extends StatefulWidget {
  const MuscleBuilding8({Key? key}) : super(key: key);

  @override
  _MuscleBuilding8State createState() => _MuscleBuilding8State();
}

class _MuscleBuilding8State extends State<MuscleBuilding8> {
  List<Map<String, dynamic>> muscleBuilding8Exercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    const collectionName = 'muscle_building_8';
    ...
    try {
      ...
      setState(() {
        muscleBuilding8Exercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Routine 9'),
        backgroundColor: Colors.blue,
      ),
      body: muscleBuilding8Exercises.isEmpty
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in muscleBuilding8Exercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: muscleBuilding8Exercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
