...
class MuscleBuilding5 extends StatefulWidget {
  const MuscleBuilding5({Key? key}) : super(key: key);

  @override
  _MuscleBuilding5State createState() => _MuscleBuilding5State();
}

class _MuscleBuilding5State extends State<MuscleBuilding5> {
  List<Map<String, dynamic>> muscleBuilding5Exercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    const collectionName = 'muscle_building_5';
    ...
    try {
      ...
      setState(() {
        muscleBuilding5Exercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Routine 6'),
        backgroundColor: Colors.blue,
      ),
      body: muscleBuilding5Exercises.isEmpty
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in muscleBuilding5Exercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: muscleBuilding5Exercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
