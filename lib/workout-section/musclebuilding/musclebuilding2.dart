...
class MuscleBuilding2 extends StatefulWidget {
  const MuscleBuilding2({Key? key}) : super(key: key);

  @override
  _MuscleBuilding2State createState() => _MuscleBuilding2State();
}

class _MuscleBuilding2State extends State<MuscleBuilding2> {
  List<Map<String, dynamic>> muscleBuilding2Exercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    const collectionName = 'muscle_building_2';
    ...
    try {
      ...
      setState(() {
        muscleBuilding2Exercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: muscleBuilding2Exercises.isEmpty
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in muscleBuilding2Exercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: muscleBuilding2Exercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
