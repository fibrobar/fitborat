...
class MuscleBuilding1 extends StatefulWidget {
  const MuscleBuilding1({Key? key}) : super(key: key);

  @override
  _MuscleBuilding1State createState() => _MuscleBuilding1State();
}

class _MuscleBuilding1State extends State<MuscleBuilding1> {
  List<Map<String, dynamic>> muscleBuilding1Exercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    const collectionName = 'muscle_building_1';
    ...
    try {
      ...
      setState(() {
        muscleBuilding1Exercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: muscleBuilding1Exercises.isEmpty
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in muscleBuilding1Exercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: muscleBuilding1Exercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
