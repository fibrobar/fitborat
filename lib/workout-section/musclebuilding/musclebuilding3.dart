...
class MuscleBuilding3 extends StatefulWidget {
  const MuscleBuilding3({Key? key}) : super(key: key);

  @override
  _MuscleBuilding3State createState() => _MuscleBuilding3State();
}

class _MuscleBuilding3State extends State<MuscleBuilding3> {
  List<Map<String, dynamic>> muscleBuilding3Exercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    const collectionName = 'muscle_building_3';
    ...
    try {
      ...
      setState(() {
        muscleBuilding3Exercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: muscleBuilding3Exercises.isEmpty
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in muscleBuilding3Exercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: muscleBuilding3Exercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
