...
class MuscleBuilding4 extends StatefulWidget {
  const MuscleBuilding4({Key? key}) : super(key: key);

  @override
  _MuscleBuilding4State createState() => _MuscleBuilding4State();
}

class _MuscleBuilding4State extends State<MuscleBuilding4> {
  List<Map<String, dynamic>> muscleBuilding4Exercises = [];
  late mongo.Db db;
  ...
  Future<void> fetchDataFromDatabase() async {
    ...
    const collectionName = 'muscle_building_4';
    ...
    try {
      ...
      setState(() {
        muscleBuilding4Exercises = fetchedData.map((doc) => {
          'day': doc['day'] ?? 'Unknown',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Routine 5'),
        backgroundColor: Colors.blue,
      ),
      body: muscleBuilding4Exercises.isEmpty
        ...
        child: Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              for (var exercise in muscleBuilding4Exercises)
                TableRow(
                  decoration: BoxDecoration(
                    color: muscleBuilding4Exercises.indexOf(exercise) % 2 == 0
                        ? Colors.white
                        : Colors.blue[50],
                  ),
                  children: [
