...
class _JumpinglungesScreenState extends State<JumpinglungesScreen> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/fatloss/jumpinglunges.mp4')
      ..initialize().then((_) {
        setState(() {});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Jumping Lunges'),
