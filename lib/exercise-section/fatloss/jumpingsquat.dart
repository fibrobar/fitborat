...
class _JumpingsquatScreenState extends State<JumpingsquatScreen> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/fatloss/jumpingsquat.mp4')
      ..initialize().then((_) {
        setState(() {});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Jumping Squat'),
