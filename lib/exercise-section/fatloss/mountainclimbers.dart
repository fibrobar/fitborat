...
class _MountainclimbersScreenState extends State<MountainclimbersScreen> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/fatloss/mountainclimbers.mp4')
      ..initialize().then((_) {
        setState(() {});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Mountain Climbers'),
