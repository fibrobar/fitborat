...
class VeganFood extends StatelessWidget {
  const VeganFood({super.key});

  @override
  Widget build(BuildContext context) {
    final List<Map<String, dynamic>> veganFoods = [
      ...
      {'food': 'Vegan pizza', 'price': '\$4.00', 'calories': '220'},
      ...
      body: Padding(
        ...
        child: Table(
          ...
          children: [
            ...
            for (var food in veganFoods)
              TableRow(
                decoration: BoxDecoration(
                  color: veganFoods.indexOf(food) % 2 == 0
                      ? Colors.white
                      : Colors.green[50],
                ),
                children: [
